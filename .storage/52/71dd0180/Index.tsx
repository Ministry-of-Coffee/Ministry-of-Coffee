      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            ...
            />
            <span className="text-xl font-bold text-[#b10c12]">Ministry of Coffee</span>
          </div>
          
          <div className="hidden md:flex items-center gap-6">
            <button
              onClick={() => scrollToSection('about')}
              className="text-gray-700 hover:text-[#b10c12] transition-colors"
            >
              {t.nav.about}
            </button>
            <button
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            <div className="flex items-center gap-3 justify-center md:justify-start mb-3">
              ...
              />
              <h3 className="text-2xl font-bold text-[#b10c12]">Ministry of Coffee</h3>
            </div>
          ...
          <div className="text-center">
            ...
            <div className="flex gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center gap-2 text-white hover:text-[#b10c12] transition-colors"
              >
                <Facebook className="h-6 w-6" />
                <span>Facebook</span>
              </a>
              <a
                href="https://www.instagram.com/ministerstwokawy/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-white hover:text-[#b10c12] transition-colors"
              >
