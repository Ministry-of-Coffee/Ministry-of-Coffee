            ...
            <CardContent className="pt-6 space-y-6">
              <div>
                <div className="flex items-start gap-3 mb-2">
                  <MapPin className="h-5 w-5 text-[#b10c12] mt-1" />
                  <div>
              ...
              <div>
                <div className="flex items-center gap-3">
                  <Phone className="h-5 w-5 text-[#b10c12]" />
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">{t.location.phone}</h3>
                    <a
                      href={`tel:${phone}`}
                      className="text-[#b10c12] hover:text-[#8a0a0e] font-medium"
                    >
                      {phone}
                    </a>
                  </div>
              ...
              <Button
                asChild
                className="w-full bg-[#b10c12] hover:bg-[#8a0a0e]"
              >
                <a
                  href={googleMapsUrl}
                  target="_blank"
